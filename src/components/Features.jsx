...
const BentoTilt = ({ children, className = '' }) => {
  ...
  // Reset the transform style when the mouse leaves the component
...
const BentoCard = ({ src, title, description }) => {
  return (
    <div className="relative size-full overflow-hidden rounded-md border border-hsla bg-black">
      <video
        src={src}
        loop
        autoPlay
  ...
  return (
    <section className='bg-black pb-52'>
      <div className='container mx-auto px-3 md:px-10'>
        ...
        <div className="grid w-full grid-cols-1 gap-7 h-auto md:grid-cols-2 md:grid-rows-3 md:h-[135vh]">
          ...
          <BentoTilt className="bento-tilt_2 row-span-1 ms-32 md:ms-0 md:col-span-1">
            <BentoCard
          ...
          <BentoTilt className="bento-tilt_2">
            <div className="flex size-full justify-between bg-violet-300 p-5">
              <h1 className="bento-title special-font text-black max-w-64">M<b>o</b>re Commi<b>n</b>g So<b>o</b>n!</h1>
